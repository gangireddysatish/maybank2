...
os.environ["KRB5_CLIENT_KTNAME"] = "/data04/datamigration/keytab/80013010-cdp.keytab"

jaas_conf = "/data04/datamigration/conf/jaas.conf"
jdbc_jars = [ "/data04/datamigration/jar/hive-jdbc-2.1.1-cdh6.3.4-standalone.jar" ]


hive_lib_dir = "/data04/datamigration/jar/"
...
extra_jars = [
    "/data04/datamigration/jar/hive-jdbc-2.1.1-cdh6.3.4-standalone.jar"
]
